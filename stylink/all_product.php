                            ...
                            <div class="tab-content">
                                <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                    <div class="product-area shop-product-area">
                                        ...
                                        // Display Search Query as a Filter
                                        if (isset($_GET['Search']) && !empty($_GET['Search'])) {
                                            // echo "<span class='filter-item'>Search: {$_GET['Search']} <button class='remove-filter' data-filter='Search'>x</button></span>";
                                            $filterLabels['Search'] = htmlspecialchars($_GET['Search']);
                                            ...
                                            <script>
                                                ...
                                                removeFilterButtons.forEach(button => {
                                                    button.addEventListener('click', () => {
                                                        ...
                                                        } else if (filterKey.startsWith('color-')) {
