...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["product_category"])) {
  ...
  if (empty($categoryName)) {
    ...
    $checkStmt = $conn->prepare("SELECT * FROM product_category WHERE username = ? AND category_name = ?");
    ...
    if ($checkResult->num_rows > 0) {
      ...
      $stmt = $conn->prepare("INSERT INTO product_category (username, category_name) VALUES (?, ?)");
...
if (isset($_GET['delete'])) {
  ...
  $deleteStmt = $conn->prepare("DELETE FROM product_category WHERE id = ? AND username = ?");
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <form class="forms-sample" action="" method="post">
                        ...
                        <input type="text" name="product_category" class="form-control" id="exampleInputName1" placeholder="Product Category" required>
                        <br>
                        <br>
                          ...
                          <tbody>
                            <?php foreach ($categories as $category) : ?>
                              <tr>
                                ...
                                <td>
                                  <a href="seller_categoryproduct.php?delete=<?php echo $category['id']; ?>" class="btn btn-outline-danger btn-fw" onclick="return confirm('Are you sure you want to delete this category?');">Delete</a>
                                </td>
                              </tr>
                            <?php endforeach; ?>
                          </tbody>
