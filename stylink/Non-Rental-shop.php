            ...
            <div class="container">
                <div class="breadcrumb-content">
                    <ul>
                        ...
                        <li class="active">Non-Rental Shop</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    /* background: #ffffff none repeat scroll 0 0; */
     position:static;
                                        ...
                                        <div class="row">
                                            ...
                                            // Fetch product data
                                            $productQuery = "SELECT * FROM seller_register WHERE store_type = 'Non-Rental' ";
                                ...
                                <li class="no-star"><i class="fa fa-star-o"></i></li>
                                                                    ...
                                                                    <h4><a class="product_name" href="single-product.php"><?php echo $product['shop_name']; ?></a></h4>
                                                                    <div class="price-box">
