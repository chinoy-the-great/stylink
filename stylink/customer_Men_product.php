                                ...
                                <div id="grid-view" class="tab-pane fade active show" role="tabpanel">
                                    <div class="product-area shop-product-area">
                                        ...
                                        <div class="row">
                                            ...
                                            // ... (add filter conditions to totalItemsQuery as you did for $productQuery)
                                                            ...
                                                            <div class="product_desc">
                                                                <div class="product_desc_info">
                                                                    <div class="product-review">
                                                                        ...
                                                                        <h5 class="manufacturer">
                                                                            <a href="customer_Men_product.php?type-filter=<?php echo $product['product_typeclothes']; ?>">(<?php echo $product['product_typeclothes']; ?>)</a>
                                                                        </h5>
                                                                    </div>
                    ...
                    <div class="col-lg-2 order-2 order-lg-1">
                        ...
                        <div class="sidebar-categores-box">
                            <div class="sidebar-title">
                                <h2>Filter By</h2>
                                <!-- <h2>Filter By</h2> -->
                                <a href="customer_Men_product.php">Clear Filter</a>
                            </div>
                                ...
                                <div class="category-checkbox">
                                    ...
                                    <div class="category-sub-menu">
                                        ...
                                        <select id="type-filter" name="type-filter">
                                            ...
                                            $sizeQuery1 = "SELECT DISTINCT product_typeclothes FROM product_list WHERE product_type = 'Men Fashion'";
